...
class ResConfigSettings(models.TransientModel):
    ...
    @api.onchange("wechat_website_auth_qrcode_width","wechat_website_auth_qrcode_hide_title","wechat_website_auth_qrcode_info_width","wechat_website_auth_qrcode_hide_status_icon","wechat_website_auth_qrcode_status_text_align")
...
.impowerBox .status {text-align: %s;}""" % (
    ...
    "none" if bool(ICP.get_param('wechat_website_auth_qrcode_hide_title')) else "block",
    ICP.get_param('wechat_website_auth_qrcode_info_width'),
    "none" if bool(ICP.get_param('wechat_website_auth_qrcode_hide_status_icon')) else "block",
