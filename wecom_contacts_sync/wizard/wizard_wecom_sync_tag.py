...
class WizardSyncTags(models.TransientModel):
    ...
    def action_sync_tags(self):
        ...
        form_view = self.env.ref("wecom_contacts_sync.dialog_wecom_contacts_sync_tag_result")
        return {
            ...
            "context": {
                "form_view_ref": "wecom_contacts_sync.dialog_wecom_contacts_sync_tag_result"
            },
