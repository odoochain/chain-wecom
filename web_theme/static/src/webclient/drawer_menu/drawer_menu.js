...
import { Component, useExternalListener, onMounted, onPatched, onWillUpdateProps, useState, useRef } from '@odoo/owl';
...
FooterComponent.template = 'web_theme.DrawerMenu.CommandPalette.Footer';
/**
 * Drawer menu
 *
...
DrawerMenu.template = 'web_theme.DrawerMenu';
