...
from odoo.addons.wechat_web.controllers import portal
from odoo.addons.wechat_web.controllers.portal import pager as portal_pager


class WechatPortal(portal.WechatPortal):
    """"""
    ...
    def _prepare_home_portal_values(self, counters):
        ...
        print(partner.name, partner.id, partner.commercial_partner_id.id)
    ...
    def _prepare_sale_portal_rendering_values(
        ...
        **kwargs,
        ...
        if quotation_page:
            url = "/wechat/web/quotes"
            domain = self._prepare_quotations_domain(partner)
        else:
            url = "/wechat/web/orders"
    ...
    @http.route(
        ["/wechat/web/quotes", "/wechat/web/quotes/page/<int:page>"],
        type="http",
        auth="user",
        website=True,
    )
    ...
    @http.route(
        ["/wechat/web/orders", "/wechat/web/orders/page/<int:page>"],
        type="http",
        auth="user",
        website=True,
    )
    def portal_my_orders(self, **kwargs):
        ...
        return request.render("wechat_web_sale.portal_my_orders", values)

    @http.route(
        ["/wechat/web/orders/<int:order_id>"], type="http", auth="public", website=True
    )
    def portal_order_page(
        ...
        **kw,
        ...
        try:
            ...
            return request.redirect("/wechat/web")
    ...
    @http.route(
        ["/wechat/web/orders/<int:order_id>/accept"],
        type="json",
        auth="public",
        website=True,
    )
    ...
    @http.route(
        ["/wechat/web/orders/<int:order_id>/decline"],
        type="http",
        auth="public",
        methods=["POST"],
        website=True,
...
class PaymentPortal(payment_portal.PaymentPortal):
    @http.route(
        "/wechat/web/orders/<int:order_id>/transaction", type="json", auth="public"
    )
