odoo.define('web_widget_markdown', function (require) {
    ...
    var markdownField = basicFields.DebouncedField.extend(basicFields.TranslatableFieldMixin, {
        ...
        template: 'pl_wecom_widget.WeComMarkdown',
        jsLibs: [
            '/pl_wecom_widget/static/lib/simplemde-markdown-editor/simplemde.min.js',
        ],
        cssLibs: [
            '/pl_wecom_widget/static/lib/simplemde-markdown-editor/simplemde.min.css',
        ],
        events: {},
