odoo.define("pl_wecom_widget.ShowPasswordFieldText", function (require) {
...
// [UPDATED] now also allows configuring products on sale order.
    ...
    var ShowPasswordFieldText = FieldChar.extend({
        ...
        template: 'pl_wecom_widget.ShowPasswordInput',
        xmlDependencies: ['/pl_wecom_widget/static/src/xml/showpasswordinput.xml'],
        ...
        _renderReadonly: function () {
            this._super.apply(this, arguments);
            var self = this;
            var $button = $(QWeb.render("pl_wecom_widget.ShowPasswordButton"));
    ...
    fieldRegistry.add('wecom_password', ShowPasswordFieldText);
