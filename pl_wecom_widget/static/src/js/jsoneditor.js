odoo.define("wecom.FieldTextJson", function (require) {
    ...
    var FieldTextJson = basic_fields.FieldText.extend({
        ...
        tagName: 'div',
        jsLibs: [
            '/pl_wecom_widget/static/lib/jsoneditor/js/jsoneditor.js',
        ],
        cssLibs: [
            '/pl_wecom_widget/static/lib/jsoneditor/jsoneditor.css',
        ],
        init: function () {
            var self = this;
            ...
            if (this.darktheme) {
                this.cssLibs.push('/pl_wecom_widget/static/lib/jsoneditor/css/darktheme.css');
            }
