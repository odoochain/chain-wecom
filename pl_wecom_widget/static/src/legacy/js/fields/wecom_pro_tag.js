...
odoo.define('pl_wecom_widget.wecom_pro_tag', function (require) {
    "use strict";
    ...
    var WecomProfessionalSuiteTag = Widget.extend({
        template: 'pl_wecom_widget.WecomProfessionalTag',
        xmlDependencies: ['/pl_wecom_widget/static/src/xml/wecom_pro_upgrade.xml'],
        events: {
            'click': '_onTagClicked',
        },
        start: function () {
        ...
        _openDialog: function () {
            var message = $(QWeb.render("pl_wecom_widget.WecomProfessionalTag.Upgrade", {
    ...
    widget_registry.add('pl_wecom_widget.wecom_pro_tag', WecomProfessionalSuiteTag);
